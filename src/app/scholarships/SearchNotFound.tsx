...
const SearchNotFound = ({ search }: SearchNotFoundProps) => {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-slate-800 bg-slate-900 px-8 py-20 text-center">
      ...
      <h2 className="text-3xl font-bold text-white">No Scholarships Found</h2>
      ...
      <p className="mt-2 text-slate-500">
        Try searching with another scholarship name or clear the search to see
        all scholarships.
      </p>
